...
enum class HttpVersion { HTTP_1_0, HTTP_1_1, HTTP_2_0, HTTP_3_0, OTHER };

static std::unordered_map<HttpMethod, std::string> MethodString = {
    {HttpMethod::GET, "GET"},         {HttpMethod::POST, "POST"},
    {HttpMethod::HEAD, "HEAD"},       {HttpMethod::PUT, "PUT"},
    {HttpMethod::DELETE, "DELETE"},   {HttpMethod::CONNECT, "CONNECT"},
    {HttpMethod::OPTIONS, "OPTIONS"}, {HttpMethod::TRACE, "TRACE"},
    {HttpMethod::PATCH, "PATCH"},     {HttpMethod::PURGE, "PURGE"}};

static std::unordered_map<std::string, HttpMethod> MethodDict = {
    {"GET", HttpMethod::GET},         {"POST", HttpMethod::POST},
    {"HEAD", HttpMethod::HEAD},       {"PUT", HttpMethod::PUT},
    {"DELETE", HttpMethod::DELETE},   {"CONNECT", HttpMethod::CONNECT},
    {"OPTIONS", HttpMethod::OPTIONS}, {"TRACE", HttpMethod::TRACE},
    {"PATCH", HttpMethod::PATCH},     {"PURGE", HttpMethod::PURGE}};
